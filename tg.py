...
n_threads = 400  
threads = []
print('\033[1;32m••••••••••••••\033[1;33m HTTP-PLAIN \033[1;32m••••••••\033[1;33mTele: @Xx_MO_ON_xX')
print()
...
def scrap():
    try:
        ...
        http = requests.get("https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/http.txt", proxies=urllib.request.getproxies(), timeout=5).text
        socks = requests.get("https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/socks5.txt", proxies=urllib.request.getproxies(), timeout=5).text
    except Exception as e:
        print(e)
        return False
...
def checker(proxy):
    ...
    try:
#        requests.get("https://t.me/httpplain/14", timeout=12, proxies=proxies)
        view2(proxy)
    except Exception as e:
        return False
